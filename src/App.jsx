        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl space-y-4">
            ...
            {params.vendor || params.id ? (
              <div className="inline-flex flex-wrap gap-2 rounded-2xl border border-white/10 bg-white/8 px-4 py-3 text-sm text-blue-100 backdrop-blur">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {offers.map((offer) => {
              ...
              return (
                <article
                  key={offer.id}
                  className={`group overflow-hidden rounded-3xl border bg-white shadow-panel transition-transform duration-300 hover:-translate-y-1 ${
                    isSelected ? 'border-blue-400 ring-2 ring-blue-300' : 'border-ink-100'
                  }`}
                >
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <div className="mt-4 rounded-2xl bg-ink-50 p-4 text-sm text-ink-700">{offer.proof}</div>
